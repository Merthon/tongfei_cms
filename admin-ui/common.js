...
function initLayout(activeMenu) {
  ...
  let sidebarHtml = `
        ...
        <div class="list-group list-group-flush mt-3 px-2">
            ...
            <a href="javascript:void(0)" onclick="tryNavigate('super_admin', '/admin/home_config.html')" class="list-group-item list-group-item-action bg-dark text-white border-0 rounded mb-1 ${activeMenu === 'home_config' ? 'active bg-primary' : ''}">
                📊 主页数据配置
            </a>
